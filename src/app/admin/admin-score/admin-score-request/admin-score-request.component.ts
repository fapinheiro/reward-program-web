...
@Component({
  selector: 'app-admin-score-request',
  templateUrl: './admin-score-request.component.html',
  styleUrls: ['./admin-score-request.component.css']
})
export class AdminScoreRequestComponent implements OnInit, OnDestroy, AfterContentInit, AfterViewInit {

  @ViewChild(AdminScoreFormComponent, {static: false}) 
  private scoreFormComponent: AdminScoreFormComponent;
  
  modeNew: AdminScoreFormModeEnum = AdminScoreFormModeEnum.NEW;
